    ...
    public static class NewRider
    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 1043 || i == 1044 || i == 1045 || i == 1052 || i == 1058 || i == 1059 || i == 1060 || i == 1061 || i == 1065 || i == 1066 || i == 1068 || i == 1069 || i == 1071 || i == 1072 || i == 1074 || 
                        i == 1078 || i == 1085 || i == 1086 || i == 1087 || i == 1095 || i == 1098)
                    {
        ...
        public static void Character()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int Character = 244;
                oPacket.WriteInt(Character - 33 - 27);
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= 1123; i++)
                {
                    if (i == 71 || i == 74 || i == 118 || i == 125 || i == 139 || i == 142 || i == 149 || i == 162 || i == 182 || i == 187 ||
                        ...
                        i == 1098 || i == 1112 || i == 1113 || i == 1114 || i == 1119 || i == 1122 || i == 1123 ||
        ...
        public static void HeadBand()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HeadBand = 528;
                oPacket.WriteInt(HeadBand + 5 - 43);
        ...
        public static void HandGearL()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HandGearL = 338;
                oPacket.WriteInt(HandGearL + 6 - 76);
                ...
                for (short i = 1; i <= HandGearL; i++)
                {
                    if (i == 21 || i == 23 || i == 44 || i == 45 || i == 48 || i == 58 || i == 61 || i == 63 || i == 67 || i == 71 ||
                        ...
                        i == 311 || i == 316 || i == 317 || i == 318 || i == 319 || i == 333)
                    {
                    }
                    else
                    {
